...
const faqs = [
  ...
  { q:"How is this different from other fitness apps?", a:"Most apps give you pre-built programs and call them personalized. The Rallis Regimen generates a program specific to you and includes training, nutrition, sleep, and environment guidance — plus The Regimen chat so you can ask questions and adjust your program any time." },
    ...
    <>
      ...
      <section className="hero">
        <div className="hero-left">
          ...
          <p className="hero-sub fade-in visible">A fully personalized program built around your body, your goals, and your life — covering training, nutrition, sleep, and environment. Updated every month. Nothing left out.</p>
        ...
        <div className="section-inner">
          ...
          <div className="steps">
            {[
              ...
              { n:"02", title:"Get Your Program", desc:"Your personalized training program, nutrition plan, sleep protocol, and environment checklist are generated and delivered immediately." },
        ...
        <div className="deliverables-inner">
          ...
          <div className="deliverables">
            {[
              ...
              { icon:"🌿", title:"Environment Guide", desc:"A prioritized action list of the highest-impact environment changes for your specific situation. Start with the easy wins, build from there." },
              ...
              { icon:"🔄", title:"Monthly Regeneration", desc:"Every billing cycle your program updates. New training, adjusted nutrition, evolving sleep and environment recommendations. The system keeps moving forward with you." }
            ].map(d => (
