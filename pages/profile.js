        ...
        <div className="main">
          ...
          {step === 3 && (
            <div>
              ...
              <div className="fg"><label className="fl">Nutrition Approach</label><div className="og"><OC selected={form.nutrition_approach==='macro_tracking'} onClick={function(){set('nutrition_approach','macro_tracking');}} label="Macro Tracking" desc="Exact grams per meal" /><OC selected={form.nutrition_approach==='fist_portions'} onClick={function(){set('nutrition_approach','fist_portions');}} label="Fist Portions" desc="Visual portions, no counting" /></div></div>
