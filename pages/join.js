    ...
    <>
      ...
      <div className="join-wrap">
        ...
        <div className="join-left">
          ...
          <p className="join-sub">Your complete personalized program — training, nutrition, and sleep — built around you and rebuilt every month.</p>
          <p className="join-sub" style={{marginTop: 16, fontSize: 13, opacity: 0.7}}>30 days free. No charge until day 31. Cancel anytime.</p>
        </div>
